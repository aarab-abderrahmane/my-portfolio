...
export function VideoText({
  ...
  return (
    <Component className={cn(`relative size-full serif-heavy text-7xl md:text-[12rem] lg:text-[15rem] leading-none tracking-tighter uppercase opacity-100`, className)}>
      ...
      <span className="sr-only serif-heavy text-7xl md:text-[12rem] lg:text-[15rem] leading-none tracking-tighter uppercase opacity-100">{content}</span>
    </Component>
  )
}
