...
export const Hero: React.FC<HeroProps> = ({ onCtaClick }) => {
  return (
    <div className="relative flex flex-col items-center justify-center text-center min-h-[100vh] w-full overflow-hidden ">
      ...
      <div className="relative z-20 flex flex-col items-center px-6 max-w-7xl mx-auto pt-32  pb-20 2xl:pt-40  w-screen">
        ...
        <h1 className="text-6xl  h-[200px] md:h-[300px] md:text-[7rem] xl:text-[8rem] w-[80%] font-black tracking-tighter leading-[0.8] mb-12">
